...
class _SearchSectionState extends State<SearchSection> {
  ...
  final List<Product> allProducts = [
    Product(name: "Scrunchies", image: "assets/image/scrunchies.webp", price: 299.99),
    Product(name: "Paper Quilling", image: "assets/image/paper_quilling.webp", price: 150.00),
                    ...
                    trailing: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        ...
                        backgroundColor: isAdded
                            ? (isDarkMode ? Colors.green[700] : Colors.lightGreen)
                            : (isDarkMode ? Colors.green[700] : Colors.lightGreen),
                      ),
                      child: Text(
